...
export class Api extends BasicApi {
  ...
  constructor() {
    ...
    let webhookConnector = new WebhookConnector(process.env.WEEBHOOK_DB, process.env.GIT_REPOSITORY_USER, process.env.GIT_REPOSITORY, process.env.GIT_URL, process.env.PRODUCTION, process.env.HORUS_MODEL, process.env.WEEBHOOK_DB_HOST, process.env.WEEBHOOK_DB_PORT);
