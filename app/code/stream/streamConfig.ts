...
export class StreamConfig extends AppObject {
    ...
    public set(component) {
        let selectedIndex = (<HTMLSelectElement>(<ComponentPageBody>component.getFather()).arrayDivisor[2].arrayDivisor[0].arrayDivisor[0].arrayDataInput[0].arrayComboBox[0].getElement()).selectedIndex;
        let selected = (<HTMLSelectElement>(<ComponentPageBody>component.getFather()).arrayDivisor[2].arrayDivisor[0].arrayDivisor[0].arrayDataInput[0].arrayComboBox[0].getElement()).options[selectedIndex].text;
        let duration = (<HTMLInputElement>(<ComponentPageBody>component.getFather()).arrayDivisor[2].arrayDivisor[0].arrayDivisor[1].arrayDataInput[0].arrayTextField[0].getElement()).value;
    ...
    public read(component) {
        let body: ComponentPageBody = <ComponentPageBody>component.getFather().getFather().getFather().getFather().getFather().getFather().getFather().getFather().getFather().getFather();
        ...
        (<HTMLInputElement>body.arrayDivisor[2].arrayDivisor[0].arrayDivisor[1].arrayDataInput[0].arrayTextField[0].getElement()).value = "" + stream.getDuration();
